...
export function createElement(type, props = {}, ...children) {
    ...
    if (typeof type === "string") {
    ...
    } else if (isComponentType) { // Jika 'type' adalah fungsi komponen
        ...
        // Jika komponen mengembalikan null, undefined, atau sesuatu yang BUKAN Node,
    ...
    if (element instanceof HTMLElement) {
        ...
        if (typeof type === "string") { // Ini juga hanya berlaku untuk elemen HTML biasa
    ...
    // Hanya tambahkan properti _componentFunction jika element adalah HTMLElement.
...
export function createComponent(renderFunction) {
    return function AnonymousComponent(props, children) {
        ...
        // Hanya cache elemen DOM jika itu HTMLElement
        if (element instanceof HTMLElement) {
...
export function mountComponent(parentDomElement, component) {
    ...
    if (render) {
        ...
        if (renderedElement instanceof Node) { // Pastikan itu Node (HTMLElement atau TextNode)
...
// --- Fungsi reRenderComponent (VERSI FINAL UNTUK ROUTER) ---
export function reRenderComponent(componentFunction) {
    ...
    // Jika komponen adalah RouterComponent, kita tidak mengganti elemen DOM-nya.
    // Kita hanya membiarkannya di-re-execute untuk memicu useEffect-nya.
    if (componentFunction.isRouter) {
        console.log("reRenderComponent: Menangani RouterComponent secara khusus. Hanya re-executing fungsi.");
        const props = oldElement._componentProps || {}; // Ambil props lama
        const children = oldElement._componentChildren || []; // Ambil children lama

        const prevCurrentRenderingComponent = currentRenderingComponent;
        currentRenderingComponent = componentFunction;
        // Re-execute fungsi komponen untuk memicu useEffect-nya
        componentFunction(props, children);
        currentRenderingComponent = prevCurrentRenderingComponent;
        runEffects(); // Pastikan efek yang di-queue dijalankan setelah re-execution
        return; // Hentikan eksekusi lebih lanjut
    }

    // Logika re-render standar untuk komponen non-Router
    if (oldElement instanceof HTMLElement && oldElement.parentNode) {
        ...
        if (newElement instanceof HTMLElement) { // Pastikan newElement juga HTMLElement untuk penggantian
            oldElement.parentNode.replaceChild(newElement, oldElement);
            componentDomCache.set(componentFunction, newElement);
        } else if (newElement instanceof Node) { // Jika newElement adalah TextNode (misal, komponen mengembalikan null)
            oldElement.parentNode.replaceChild(newElement, oldElement);
        ...
        } else { // Jika newElement adalah null/undefined
...
// --- Fungsi-fungsi Utilitas Lainnya (loadJSON, getData, setData, focus, setFlex, setGrid, flexCenter, animate, fadeIn, fadeOut) ---
// Pastikan semua fungsi ini tetap ada di core.js Anda.
...
export const label = htmlElements.label;
export const form = htmlElements.form;
export const ul = htmlElements.ul;
export const ol = htmlElements.ol;
export const li = htmlElements.li;
export const span = htmlElements.span;
export const nav = htmlElements.nav;
export const footer = htmlElements.footer;
export const header = htmlElements.header;
export const section = htmlElements.section;
export const article = htmlElements.article;
export const aside = htmlElements.aside;
export const main = htmlElements.main;
export const img = htmlElements.img;
export const table = htmlElements.table;
export const thead = htmlElements.thead;
export const tbody = htmlElements.tbody;
export const tfoot = htmlElements.tfoot;
export const tr = htmlElements.tr;
export const th = htmlElements.th;
export const td = htmlElements.td;
export const caption = htmlElements.caption;
export const colgroup = htmlElements.colgroup;
export const col = htmlElements.col;
export const video = htmlElements.video;
export const audio = htmlElements.audio;
export const source = htmlElements.source;
export const track = htmlElements.track;
export const picture = htmlElements.picture;
export const canvas = htmlElements.canvas;
export const iframe = htmlElements.iframe;
export const svg = htmlElements.svg;
export const path = htmlElements.path;
export const figcaption = htmlElements.figcaption;
export const figure = htmlElements.figure;
export const br = htmlElements.br;
export const hr = htmlElements.hr;
export const time = htmlElements.time;
export const meter = htmlElements.meter;
export const progress = htmlElements.progress;
export const details = htmlElements.details;
export const summary = htmlElements.summary;
export const mark = htmlElements.mark;
export const small = htmlElements.small;
export const abbr = htmlElements.abbr;
export const cite = htmlElements.cite;
export const ins = htmlElements.ins;
export const del = htmlElements.del;
export const sup = htmlElements.sup;
export const sub = htmlElements.sub;
export const blockquote = htmlElements.blockquote;
export const pre = htmlElements.pre;
export const code = htmlElements.code;
export const checkbox = htmlElements.checkbox;
export const radio = htmlElements.radio;
...
export const fieldset = htmlElements.fieldset;
export const legend = htmlElements.legend;

// --- RE-EXPORT FUNGSI DAN KOMPONEN DARI router.js ---
import { setRoutes, navigateTo, Link, Router } from './router.js';
export { setRoutes, navigateTo, Link, Router };

// --- RE-EXPORT KOMPONEN SVGLogo dan Modal ---
// PASTIKAN Anda telah memindahkan Modal.js ke src/PureView/Modal.js
import { SVGLogo } from './svg.js';
import { Modal } from './modal.js'; // Asumsi Modal.js sudah dipindahkan ke PureView/
export { SVGLogo, Modal };
