...
```javascript
import { div, h2, p, button, section, createSignal } from 'directdom-lite';
...
export function LiveDemoCounter() {
  ...
  return section({ style: "margin-bottom: 40px;" }, 
    ...
    div({ style: "background: #1e1e1e; padding: 25px; border-radius: 8px; border: 1px solid #333; text-align: center; margin: 20px 0; box-shadow: 0 4px 6px rgba(0,0,0,0.3);" }, 
      textElement, 
      buttonElement
    )
  );
